...
export default function BreadcrumbOverlay({}) {
  ...
  return (
    <div className="opacity-60 hover:opacity-100 flex flex-col items-start">
      {withoutMostRecentBreadcrumb.length != 0 ? (
        <div className="max-w-5 max-h-5 ms-20">
          <svg
            viewBox="0 0 100 265"
      ...
      {withoutMostRecentBreadcrumb.map((breadcrumb) => {
        return (
          <div
            ...
            className="text-green-800 bg-white border-green-700 border-2 rounded-lg p-3 max-w-50 min-w-50 cursor-default last:cursor-pointer mb-2"
