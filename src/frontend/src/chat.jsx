...
<Response
  className="w-full rounded-lg border border-gray-200 bg-gray-50 p-2 text-sm break-words [&_h2]:mt-4 [&_h2]:text-sm [&_h2]:font-bold [&_h2]:border-b [&_h2]:border-gray-300 [&_h2]:pb-1"
