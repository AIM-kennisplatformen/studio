...
app.mount("/app", StaticFiles(directory="kg", html=True), name="frontend")
...
async def me(request: Request):
    """
    Return identity information based on forwarded headers.
    Works with Traefik + Authentik ForwardAuth or returns
    anonymous info when auth is disabled.
    """
